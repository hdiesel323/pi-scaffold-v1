...
4. **Knowledge Persistence**: Ensure `docs/ZETTELGHEST.md` is updated with all new extensions and agents.

## Behavioral Guidelines
- Be concise and technical.
- Focus on "what changed" and "what's next".
- Ensure all paths mentioned are relative to the project root `/Users/admin/pi-swarm/`.
