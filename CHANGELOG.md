...
### Changed
- Aligned the team rollout metadata, version files, and onboarding guidance for the 1.2.1 release.
- Standardized the user-facing model guidance around `pi --list-models` and provider/model pairs.
- Hardened the session wrap and scaffold verification path for fresh-project onboarding.
